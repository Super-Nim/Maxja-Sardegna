...
export interface MaxjaAirdropInterface extends utils.Interface {
  functions: {
    ...
    "sendNFT(address,string)": FunctionFragment;
...
export interface MaxjaAirdrop extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MaxjaAirdropInterface;
